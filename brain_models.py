...
def error_FC(var, DE, W, tspan, step, atol, rtol, cutoff, band, exp_PLI, \
                normalize_exp, threshold_exp, normalize_sim, threshold_sim, zero_scale, y0, inds, objective, freq_normal):
    # find N
    ...
    coherence_error = 5 * np.abs(np.mean(compute_phase_coherence(x)) - 0.1)
